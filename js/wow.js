(function (global, factory) {
    ...
    function createEvent(event) {
        let bubble = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
        let cancel = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
        let detail = arguments.length <= 3 || arguments[3] === undefined ? null : arguments[3];
    ...
    let WeakMap = window.WeakMap || window.MozWeakMap || function () {
        function WeakMap() {
    ...
    let MutationObserver = window.MutationObserver || window.WebkitMutationObserver || window.MozMutationObserver || (_temp = _class = function () {
    ...
    let WOW = function () {
        ...
        _createClass(WOW, [{
            ...
            value: function start() {
                ...
                if (this.config.live) {
                    let mut = new MutationObserver(function (records) {
            ...
            value: function isVisible(box) {
                ...
                let viewBottom = viewTop + Math.min(this.element.clientHeight, getInnerHeight()) - offset;
